  ...
  var JMuxmer = /*#__PURE__*/function (_Event) {
    ...
    function JMuxmer(options) {
      ...
      var defaults = {
        ...
        fps: 30,
        debug: false,
        onReady: function onReady() {} // function called when MSE is ready to accept frames
    ...
    _createClass(JMuxmer, [{
      ...
      value: function feed(data) {
        ...
        if (!data || !this.remuxController) return; // console.log(`jmuxer:feed data.video.length = ${data.video.length}`);
